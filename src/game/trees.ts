...
import { Orange } from "./food";

export type TreeType = GameClass & { tree: null };

export class Tree extends Interactable {
  static readonly tree: null; //Only Tree and Tree's subclasses have this
...
export class Twig extends TreeItem {
...
export class Root extends TreeItem {
  // Roots require Knife
  constructor(treeType: TreeType) {
    super();
...
export class Bark extends TreeItem {
  // Bark requires Knife
  constructor(treeType: TreeType) {
    super();
...
export class Log extends TreeItem {
...
export class TreeStump extends TreeItem {
...
export class Citrus extends Tree {
  constructor(type: Orange | Lemon | Lime | Grapefruit) {
    super(type.getName(1), `A ${type.getName(1)} tree.`, 35, "Iron");
  }
