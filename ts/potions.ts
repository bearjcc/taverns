...
export const aquaExevoPotentia_prototype: AquaExevoPotentia = new AquaExevoPotentia();
...
export const aquaExevoSanctus_prototype: AquaExevoSanctus = new AquaExevoSanctus();
...
export const aquaExevoTenebrae_prototype: AquaExevoTenebrae = new AquaExevoTenebrae();
