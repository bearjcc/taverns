...
export class Continent extends Destination {
    static readonly description: string = "Large body of land whose borders are denoted by techtonic plates: oceans or mountain ranges";
...
export class Island extends Destination {
    static readonly description: string = "Small body of land surronded by water";
    constructor(name: string, description: string) {
...
export class State extends Destination {
    static readonly description: string = "Large area of land with a governing body";
...
export class Settlement extends Destination {
    static readonly description: string = "An area where Humanoids live with a government";
    government: Government;
    governmentdescription: string;
    leader: Being;
    state: State;
...
export class SkillingLocation extends Destination {
    static readonly description: string = "An area where players can easily increase their skill xp";
    lat: number;
    lng: number;
    region: Region;
    continent: Continent;
...
export class Ruins extends Settlement {
    static readonly description: string = "A place where ancient artifacts can be found";
}
...
export class Capital extends City {
    static readonly description: string = "A city where the seat of government for a state governs from";
}
...
export class Homestead extends Settlement {
    static readonly description: string = "A small, rural settlement with a single owner";
}
...
export class Port extends Settlement {
    static readonly description: string = "A place for boats to dock and load or unload goods";
}
...
export class DigSite extends SkillingLocation {
    static readonly description: string = "A place where artifacts can be found";
}

export class Building extends Destination {
    static readonly description: string = "A permanent Humanoid built structure";
    settlement: Settlement;
...
export class Temple extends Building {
    static readonly description: string = "A building for the worship of the gods";
}

export class Tavern extends Building {
    static readonly description: string = "A building for the sale of drinks and food";
}
...
export class GeneralStore extends Building {
    static readonly description: string = "A building for the sale of general goods";
}
...
export class Armory extends Building {
    static readonly description: string = "A building for the sale of weapons and armor";
}
...
export class Haberdashery extends Building {
    static readonly description: string = "A building for the sale of fancy clothing and accessories";
}
...
export class Road extends Destination {
    ...
    constructor(name: string, description: string, settlement1: Settlement, settlement2: Settlement) {
        super(name, description);
...
export class Forest extends Destination {
    static readonly description: string = "A place where trees are in abundance";
}
...
export class Desert extends Destination {
    static readonly description: string = "An area where very little rain falls";
}
...
export class MountainRange extends Destination {
    static readonly description: string = "Many mountains in a continuous row caused by techtonic plates colliding";
}
...
export class River extends BodyofWater {
    static readonly description: string = "A large, long, flowing body of fresh water";
}
...
export class Creek extends BodyofWater {
    static readonly description: string = "A small, narrow, flowing body of fresh water";
}
...
export class Battlefield extends Destination {
    static readonly description: string = "A place where a large fight has occured";
}

export class Aqueduct extends Destination {
    static readonly description: string = "A humanoid structure for transporting water suing the power of gravity";
}

var BlackDuct = new Aqueduct("The Black Duct", "");

export class Bridge extends Destination {
    static readonly description: string = "A structure that allows for crossing a body of water";
}
